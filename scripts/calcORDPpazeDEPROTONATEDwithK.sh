#!/bin/bash
tmpDIRname=OPcalcDEPROTpazewithKtmp
tprname=/wrk/ollilas1/OXIDIZEDdata/DEPROTONATED/withK/pzpcRUN2.tpr
tprname402=/wrk/ollilas1/OXIDIZEDdata/DEPROTONATED/withK/402.tpr
...
HGGLYoutname=../../Data/DEPROTONATED/withK/OrderParamGHGLYpaze.dat
sn1outname=../../Data/DEPROTONATED/withK/OrderParamSN1paze.dat
sn2outname=../../Data/DEPROTONATED/withK/OrderParamSN2paze.dat
groOPpath=../gro_OP.awk
hdbFILE=../ffgmx2.hdb
mkdir $tmpDIRname
cd $tmpDIRname
cp $hdbFILE ./ffgmx2.hdb
echo System | trjconv -f $trajname -s $tprname -o trajINBOX.xtc -pbc res -b 0
