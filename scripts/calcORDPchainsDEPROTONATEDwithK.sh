#!/bin/bash
tmpDIRname=OPcalcDEPROTwithKtmp
...
HGGLYoutname=../../Data/DEPROTONATED/withK/OrderParamGHGLY.dat
sn1outname=../../Data/DEPROTONATED/withK/OrderParamSN1.dat
sn2outname=../../Data/DEPROTONATED/withK/OrderParamSN2.dat
