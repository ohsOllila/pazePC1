tmpdir=APMcalcTMPprotonated
tprname=../../../OXIDIZEDdata/PROTONATED/pzpcRUN2.tpr
trajname=../../../OXIDIZEDdata/PROTONATED/pzpcRUN1-3.xtc
outfile=../../Data/PROTONATED/areaPERmolecule.dat
starttime=100000
endtime=159000
mkdir $tmpdir
cd $tmpdir
